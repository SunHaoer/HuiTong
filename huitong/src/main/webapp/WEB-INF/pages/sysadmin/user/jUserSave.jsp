		...
		<div>
			<div class="eXtremeTable">
				<table id="ec_table" class="tableRegion" width="98%">
					...
					<tr class="odd">
						<td>所属部门:</td>
						<td><select name="dept.deptId" style="width: 120px">
					...
					<tr class="odd">
						<td>用户级别:</td>
						<td><select name="userInfo.userLevel" style="width: 120px">
					...
					<tr class="odd">
						<td>状态:</td>
						<td colspan="3"><input type="radio" name="state" value="1" />启用
							<input type="radio" name="state" value="0" />停用</td>
					</tr>
					<tr class="odd">
						<td>备注信息:</td>
						<td colspan="3"><textarea name="userInfo.remark"
								style="height: 80px; width: 100%"></textarea></td>
					</tr>
				</table>
			</div>
