...
public final class main_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<td class=\"model_intro_right\">横向模块权限控制(菜单、按钮、状态、功能点),\r\n");
      out.write("\t\t\t\t\t\t纵向数据权限控制(行政部门、职务等级、管辖部门、管辖人员)。\r\n");
      out.write("\t\t\t\t\t\t<p>＝严密的数据访问控制,充分保障数据的安全性。</p>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td class=\"model_intro_left\">角色管理：</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"model_intro_right\">对人员角色进行权限分配, 实现用户权限批量设置,\r\n");
      out.write("\t\t\t\t\t\t支持细粒度权限控制分配(菜单、按钮、状态、功能点)。</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t<td class=\"model_intro_right\" width=\"81%\">可对系统操作用户进行维护管理,\r\n");
      out.write("\t\t\t\t\t\t维护信息包括用户账号、所属部门、功能权限等, 并支持对特殊用户账号锁定禁用操作。 <br />管辖部门管辖人员：实现对特定部门,\r\n");
      out.write("\t\t\t\t\t\t特定人员分管关系。\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\r\n");
