				...
				<table border=0 cellspacing="0" cellpadding="0" width="220">
					<tr>
						<td style='cursor: move;'
							...
							background="${ctx}/staticfile/images/olmsg/C0FFE51.gif"
							height="45"><input type="hidden" name="id" class="input"
						...
						<td style='cursor: move; white-space: nowrap;' width='100%'
							...
							<div
								...
								<a style='cursor: pointer;' title="编辑"
									...
									src="${ctx}/staticfile/images/olmsg/doc_edit.gif" /></a> <a
					...
					<tr>
						<td id="tagBPic"
							background="${ctx}/staticfile/images/olmsg/C0FFE53.gif"
							height="63">
							<table border="0" width="100%" cellspacing="0" cellpadding="0">
								<tr>
									<td width="50" align="center"><img border="0"
										src="${ctx}/staticfile/images/olmsg/2.gif"></td>
				...
				<table border=0 cellspacing="0" cellpadding="0" width="220">
					<tr>
						<td style='cursor: move;'
							...
							background="${ctx}/staticfile/images/olmsg/FFE7E81.gif"
							height="45"><input type="hidden" name="id" class="input"
					...
					<tr>
						<td id="tagBPic"
							background="${ctx}/staticfile/images/olmsg/FFE7E83.gif"
							height="63">
							<table border="0" width="100%" cellspacing="0" cellpadding="0">
								<tr>
									<td width="50" align="center"><img border="0"
										src="${ctx}/staticfile/images/olmsg/0.gif"></td>
									<td style="text-align: right; padding-right: 8px;" nowrap>
										[备忘] <!-- [回复] --> <!-- [回执] --> <!-- [撤销原因] --> <!-- state==99[完成] -->
									</td>
								</tr>
